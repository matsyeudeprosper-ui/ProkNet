...
| v0.12.2 | Accueil and Carte redesigned from scratch: a drawn sonar button (`PulseButtonView`, rings sweep while searching), three quiet tiles, two door cards; the map is a sonar of real sightings (you at the centre, fresh near, old far, tappable) or the cell grid once a position exists | built, 236 JVM tests pass, one-tap hardware regression pending |
