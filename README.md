...
| v0.9.15 | The radio: peer discovery stops the moment somebody joins, because scanning takes a single-radio phone off the group channel, and a UDP link probe measures whether any IP packet crosses the link at all | built, 153 JVM tests pass |
