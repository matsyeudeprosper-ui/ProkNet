...
| v0.9.3 | Link setup fails fast with a real reason: per-step timeouts, the host says at once when it cannot create the hotspot, the buyer screen says what to check, the seller screen warns about Wi-Fi / Location | built, 108 JVM tests pass |
